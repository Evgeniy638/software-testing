...
{
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE, EIF_INTEGER_32, EIF_INTEGER_32)) (a -> address)) (a -> target, a -> argument [0].it_r, a -> argument [1].it_i4, a -> argument [2].it_i4);
}
