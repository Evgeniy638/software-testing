...
EIF_REFERENCE F451_3179 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 450, Current, 0, 0, 4110);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F706_4432(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F451_3182 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 450, Current, 0, 0, 4111);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
