...
/* {LINEAR}.has */
EIF_BOOLEAN F404_2703 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("has", 403, Current, 0, 1, 3833);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(4);
	Result = (nstcall = 0, F404_2709(Current));
...
/* {LINEAR}.index_of */
EIF_INTEGER_32 F404_2704 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	RTEX;
	...
	RTEAA("index_of", 403, Current, 2, 2, 3834);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) (*(EIF_BOOLEAN *)(Current + O2308[dtype-186]) && EIF_TRUE)) {
		...
		for (;;) {
			...
			if (tb1) break;
			RTHOOK(6);
			if (((nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2387[dtype-546])(Current)) == arg1)) {
				RTHOOK(7);
				loc1++;
			}
			RTHOOK(8);
		...
		for (;;) {
			...
			if (tb2) break;
			RTHOOK(13);
			if ((EIF_BOOLEAN)((nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2387[dtype-546])(Current)) == arg1)) {
				RTHOOK(14);
				loc1++;
			}
			RTHOOK(15);
...
/* {LINEAR}.search */
void F404_2705 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 403, Current, 0, 1, 3835);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (*(EIF_BOOLEAN *)(Current + O2308[dtype-186])) {
		for (;;) {
			...
			tb1 = '\01';
			if (!(nstcall = 0, F404_2709(Current))) {
				tb1 = (arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2387[dtype-546])(Current)));
			}
			if (tb1) break;
			RTHOOK(3);
			(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2405[dtype-546])(Current));
		...
		for (;;) {
			...
			tb2 = '\01';
			if (!(nstcall = 0, F404_2709(Current))) {
				tb2 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2387[dtype-546])(Current)));
			}
			if (tb2) break;
			RTHOOK(5);
			(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2405[dtype-546])(Current));
	...
	if (RTAL & CK_ENSURE) {
		...
		if (tb4) {
			tb3 = (arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2387[dtype-546])(Current)));
		}
		if (tb3) {
			RTCK;
		} else {
		...
		if (tb4) {
			tb3 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2387[dtype-546])(Current)));
		}
		if (tb3) {
			RTCK;
		} else {
...
/* {LINEAR}.occurrences */
EIF_INTEGER_32 F404_2707 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
	...
	RTEAA("occurrences", 403, Current, 0, 1, 3836);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_CHARACTER_8 F404_2708 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item_for_iteration", 403, Current, 0, 0, 3837);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	Result = (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2387[dtype-546])(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
/* {LINEAR}.exhausted */
EIF_BOOLEAN F404_2709 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("exhausted", 403, Current, 0, 0, 3838);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.off */
EIF_BOOLEAN F404_2711 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("off", 403, Current, 0, 0, 3839);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.do_all */
void F404_2714 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("do_all", 403, Current, 3, 1, 3840);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		RTHOOK(7);
		tc1 = (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2387[dtype-546])(Current));
	...
	if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(loc2 != NULL) && (EIF_BOOLEAN)(loc1 != NULL))) {
		RTHOOK(10);
		(nstcall = 1, F646_4210(RTCW(loc2), loc1));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(11);
...
/* {LINEAR}.do_if */
void F404_2715 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("do_if", 403, Current, 3, 2, 3841);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.there_exists */
EIF_BOOLEAN F404_2716 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("there_exists", 403, Current, 3, 1, 3842);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.for_all */
EIF_BOOLEAN F404_2717 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("for_all", 403, Current, 3, 1, 3843);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F404_2718 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("linear_representation", 403, Current, 0, 0, 3844);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}._invariant */
void F404_1 (EIF_REFERENCE Current, int where)
{
	GTCX
