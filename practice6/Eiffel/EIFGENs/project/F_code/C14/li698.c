...
/* {LINEAR}.has */
EIF_BOOLEAN F405_2703 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("has", 404, Current, 0, 1, 3846);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(4);
	Result = (nstcall = 0, F405_2709(Current));
...
/* {LINEAR}.index_of */
EIF_INTEGER_32 F405_2704 (EIF_REFERENCE Current, EIF_REAL_32 arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	RTEX;
	...
	RTEAA("index_of", 404, Current, 2, 2, 3847);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.search */
void F405_2705 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 404, Current, 0, 1, 3848);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (*(EIF_BOOLEAN *)(Current + O2308[dtype-186])) {
		...
		for (;;) {
			...
			tb2 = '\01';
			if (!(nstcall = 0, F405_2709(Current))) {
				tb2 = (EIF_BOOLEAN) eif_is_equal_real_32 (arg1, (nstcall = 0, F641_4179(Current)));
			}
			if (tb2) break;
			RTHOOK(5);
			(nstcall = 0, F641_4207(Current));
	...
	if (RTAL & CK_ENSURE) {
		...
		if (tb4) {
			tb3 = (EIF_BOOLEAN) eif_is_equal_real_32 (arg1, (nstcall = 0, F641_4179(Current)));
		}
		if (tb3) {
			RTCK;
		} else {
...
/* {LINEAR}.occurrences */
EIF_INTEGER_32 F405_2707 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
	...
	RTEAA("occurrences", 404, Current, 0, 1, 3849);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_32 F405_2708 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item_for_iteration", 404, Current, 0, 0, 3850);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.exhausted */
EIF_BOOLEAN F405_2709 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("exhausted", 404, Current, 0, 0, 3851);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.off */
EIF_BOOLEAN F405_2711 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("off", 404, Current, 0, 0, 3852);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.do_all */
void F405_2714 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("do_all", 404, Current, 3, 1, 3853);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(6);
		if ((nstcall = 0, F526_3434(Current))) break;
		RTHOOK(7);
		tr4_1 = (nstcall = 0, F641_4179(Current));
	...
	if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(loc2 != NULL) && (EIF_BOOLEAN)(loc1 != NULL))) {
		RTHOOK(10);
		(nstcall = 1, F641_4210(RTCW(loc2), loc1));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(11);
...
/* {LINEAR}.do_if */
void F405_2715 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("do_if", 404, Current, 3, 2, 3854);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.there_exists */
EIF_BOOLEAN F405_2716 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("there_exists", 404, Current, 3, 1, 3855);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}.for_all */
EIF_BOOLEAN F405_2717 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("for_all", 404, Current, 3, 1, 3856);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F405_2718 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("linear_representation", 404, Current, 0, 0, 3857);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LINEAR}._invariant */
void F405_1 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 697, Current, 0, 0);
