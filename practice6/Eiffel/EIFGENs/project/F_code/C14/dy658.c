...
EIF_BOOLEAN F510_3418 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 509, Current, 0, 0, 6229);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F510_3424 (EIF_REFERENCE Current, EIF_NATURAL_8 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune", 509, Current, 0, 1, 6230);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F510_3425 (EIF_REFERENCE Current, EIF_NATURAL_8 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune_all", 509, Current, 0, 1, 6231);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F510_3428 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 509, Current, 3, 1, 6232);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = 0, F640_4228(Current));
	RTHOOK(8);
	(nstcall = 0, F640_4209(Current, loc1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tu1_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_NATURAL_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3242[Dtype(loc3)-661])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3296[Dtype(loc3)-695])(loc3));
...
void F510_3429 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 509, Current, 0, 0, 6233);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F324_2638(Current))) break;
		RTHOOK(4);
		(nstcall = 0, F640_4228(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F510_3430 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 509, Current, 2, 1, 6234);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	Result = (nstcall = 0, F640_4236(Current));
	RTHOOK(4);
	if (*(EIF_BOOLEAN *)(Current + O2308[dtype-186])) {
		RTHOOK(5);
		(nstcall = 1, F195_2564(RTCW(Result)));
	}
	RTHOOK(6);
	...
	for (;;) {
		...
		(nstcall = 1, F640_4215(RTCW(Result), tu1_1));
		RTHOOK(9);
