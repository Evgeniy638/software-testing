...
EIF_BOOLEAN F513_3418 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 512, Current, 0, 0, 6247);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F513_3424 (EIF_REFERENCE Current, EIF_INTEGER_64 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune", 512, Current, 0, 1, 6248);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F513_3425 (EIF_REFERENCE Current, EIF_INTEGER_64 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune_all", 512, Current, 0, 1, 6249);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F513_3428 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 512, Current, 3, 1, 6250);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = 0, F643_4228(Current));
	RTHOOK(8);
	(nstcall = 0, F643_4209(Current, loc1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				ti8_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_INTEGER_64 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3242[Dtype(loc3)-661])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3296[Dtype(loc3)-695])(loc3));
...
void F513_3429 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 512, Current, 0, 0, 6251);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F328_2638(Current))) break;
		RTHOOK(4);
		(nstcall = 0, F643_4228(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F513_3430 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 512, Current, 2, 1, 6252);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	Result = (nstcall = 0, F643_4236(Current));
	RTHOOK(4);
	if (*(EIF_BOOLEAN *)(Current + O2308[dtype-186])) {
		RTHOOK(5);
		(nstcall = 1, F199_2564(RTCW(Result)));
	}
	RTHOOK(6);
	...
	for (;;) {
		...
		(nstcall = 1, F643_4215(RTCW(Result), ti8_1));
		RTHOOK(9);
