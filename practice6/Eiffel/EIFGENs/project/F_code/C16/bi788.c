...
/* {BILINEAR}.off */
EIF_BOOLEAN F421_2811 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("off", 420, Current, 0, 0, 3945);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BILINEAR}.search */
void F421_2814 (EIF_REFERENCE Current, EIF_INTEGER_64 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 420, Current, 0, 1, 3946);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(3);
	(nstcall = 0, F407_2705(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
void F421_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 787, Current, 0, 0);
