...
EIF_INTEGER_64 F693_4426 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 692, Current, 0, 0, 8526);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	ti8_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_INTEGER_64 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2654[Dtype(RTCW(tr1))-470])(tr1, ti4_1));
