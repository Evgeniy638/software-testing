...
EIF_INTEGER_64 F725_4466 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 724, Current, 0, 0, 9086);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((EIF_BOOLEAN) !(nstcall = 0, F725_4475(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	ti8_1 = (nstcall = 1, F570_3187(RTCW(tr1), *(EIF_INTEGER_32 *)(Current + O3323[dtype-713])));
...
EIF_INTEGER_32 F725_4467 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("cursor_index", 724, Current, 0, 0, 9087);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F725_4468 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("target_index", 724, Current, 0, 0, 9088);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F725_4469 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("last_index", 724, Current, 0, 0, 9089);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F725_4470 (EIF_REFERENCE Current)
{
	return (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
}

/* {GENERAL_SPECIAL_ITERATION_CURSOR}.reversed */
EIF_REFERENCE F725_4471 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("reversed", 724, Current, 0, 0, 9091);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		...
		Result = RTLNS(typres0.id, 707, _OBJSIZ_1_1_0_5_0_0_0_0_);
	}
	tr1 = (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3309[dtype-695])(Current));
	(nstcall = -1, F708_4432(RTCW(Result), tr1));
	RTHOOK(2);
	(nstcall = 1, F708_4449(RTCW(Result)));
	RTHOOK(3);
	(nstcall = 1, F708_4451(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("is_reversed", EX_POST);
		tb1 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R3304[Dtype(RTCW(Result))-695])(Result));
		if ((EIF_BOOLEAN)(tb1 == (EIF_BOOLEAN) !(nstcall = 0, F725_4476(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN)(ti4_1 == (nstcall = 0, F725_4470(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F725_4472 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("incremented", 724, Current, 0, 1, 9092);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
		RTTE((EIF_BOOLEAN) ((EIF_INTEGER_32) ((nstcall = 0, F725_4470(Current)) + arg1) > ((EIF_INTEGER_32) 0L)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	(nstcall = -1, F708_4432(RTCW(Result), tr1));
	RTHOOK(3);
	(nstcall = 1, F708_4450(RTCW(Result), (EIF_INTEGER_32) (((EIF_INTEGER_32) 1L) + arg1)));
	RTHOOK(4);
	(nstcall = 1, F708_4451(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		...
		ti4_1 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3299[Dtype(RTCW(Result))-695])(Result));
		if ((EIF_BOOLEAN)(ti4_1 == (EIF_INTEGER_32) ((nstcall = 0, F725_4470(Current)) + arg1))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		tb1 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R3304[Dtype(RTCW(Result))-695])(Result));
		if ((EIF_BOOLEAN)(tb1 == (nstcall = 0, F725_4476(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F725_4473 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("decremented", 724, Current, 0, 1, 9093);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
		RTTE((EIF_BOOLEAN) ((nstcall = 0, F725_4470(Current)) > arg1), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
EIF_REFERENCE F725_4474 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("with_step", 724, Current, 0, 1, 9094);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = -1, F708_4432(RTCW(Result), tr1));
	RTHOOK(3);
	(nstcall = 1, F708_4450(RTCW(Result), arg1));
	RTHOOK(4);
	(nstcall = 1, F708_4451(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
EIF_BOOLEAN F725_4475 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("after", 724, Current, 0, 0, 9095);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F725_4476 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_FALSE;
}

/* {GENERAL_SPECIAL_ITERATION_CURSOR}.is_valid */
EIF_BOOLEAN F725_4477 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_valid", 724, Current, 0, 0, 9097);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	ti4_2 = (nstcall = 0, F725_4469(Current));
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN)(ti4_1 == ti4_2);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
EIF_BOOLEAN F725_4478 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_first", 724, Current, 0, 0, 9098);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F725_4479 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_last", 724, Current, 0, 0, 9099);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F725_4480 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("start", 724, Current, 0, 0, 9100);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	*(EIF_INTEGER_32 *)(Current + O3323[dtype-713]) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F725_4467(Current)) == ((EIF_INTEGER_32) 1L))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F725_4468(Current)) == (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3297[dtype-695])(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((nstcall = 0, F725_4478(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F725_4481 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("forth", 724, Current, 0, 0, 9101);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
		ti4_1 = (nstcall = 0, F725_4467(Current));
		tr1 = NULL;
		RTE_O
		tr1 = RTLA;
		RTE_OE
	...
	if (RTAL & CK_ENSURE) {
		...
		RTCO(tr1);
		if ((EIF_BOOLEAN)((nstcall = 0, F725_4467(Current)) == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F725_4482 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F725_4483 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F725_4485 (EIF_REFERENCE Current)
{
