...
EIF_NATURAL_64 F724_4466 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 723, Current, 0, 0, 9067);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((EIF_BOOLEAN) !(nstcall = 0, F724_4475(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	tu8_1 = (nstcall = 1, F569_3187(RTCW(tr1), *(EIF_INTEGER_32 *)(Current + O3323[dtype-713])));
...
EIF_INTEGER_32 F724_4467 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("cursor_index", 723, Current, 0, 0, 9068);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F724_4468 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("target_index", 723, Current, 0, 0, 9069);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F724_4469 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("last_index", 723, Current, 0, 0, 9070);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F724_4470 (EIF_REFERENCE Current)
{
	return (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
}

/* {GENERAL_SPECIAL_ITERATION_CURSOR}.reversed */
EIF_REFERENCE F724_4471 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("reversed", 723, Current, 0, 0, 9072);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		...
		Result = RTLNS(typres0.id, 706, _OBJSIZ_1_1_0_5_0_0_0_0_);
	}
	tr1 = (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3309[dtype-695])(Current));
	(nstcall = -1, F707_4432(RTCW(Result), tr1));
	RTHOOK(2);
	(nstcall = 1, F707_4449(RTCW(Result)));
	RTHOOK(3);
	(nstcall = 1, F707_4451(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("is_reversed", EX_POST);
		tb1 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R3304[Dtype(RTCW(Result))-695])(Result));
		if ((EIF_BOOLEAN)(tb1 == (EIF_BOOLEAN) !(nstcall = 0, F724_4476(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN)(ti4_1 == (nstcall = 0, F724_4470(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F724_4472 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("incremented", 723, Current, 0, 1, 9073);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
		RTTE((EIF_BOOLEAN) ((EIF_INTEGER_32) ((nstcall = 0, F724_4470(Current)) + arg1) > ((EIF_INTEGER_32) 0L)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	(nstcall = -1, F707_4432(RTCW(Result), tr1));
	RTHOOK(3);
	(nstcall = 1, F707_4450(RTCW(Result), (EIF_INTEGER_32) (((EIF_INTEGER_32) 1L) + arg1)));
	RTHOOK(4);
	(nstcall = 1, F707_4451(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		...
		ti4_1 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3299[Dtype(RTCW(Result))-695])(Result));
		if ((EIF_BOOLEAN)(ti4_1 == (EIF_INTEGER_32) ((nstcall = 0, F724_4470(Current)) + arg1))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		tb1 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R3304[Dtype(RTCW(Result))-695])(Result));
		if ((EIF_BOOLEAN)(tb1 == (nstcall = 0, F724_4476(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F724_4473 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("decremented", 723, Current, 0, 1, 9074);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
		RTTE((EIF_BOOLEAN) ((nstcall = 0, F724_4470(Current)) > arg1), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
EIF_REFERENCE F724_4474 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("with_step", 723, Current, 0, 1, 9075);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = -1, F707_4432(RTCW(Result), tr1));
	RTHOOK(3);
	(nstcall = 1, F707_4450(RTCW(Result), arg1));
	RTHOOK(4);
	(nstcall = 1, F707_4451(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
EIF_BOOLEAN F724_4475 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("after", 723, Current, 0, 0, 9076);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F724_4476 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_FALSE;
}

/* {GENERAL_SPECIAL_ITERATION_CURSOR}.is_valid */
EIF_BOOLEAN F724_4477 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_valid", 723, Current, 0, 0, 9078);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	ti4_2 = (nstcall = 0, F724_4469(Current));
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN)(ti4_1 == ti4_2);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
EIF_BOOLEAN F724_4478 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_first", 723, Current, 0, 0, 9079);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F724_4479 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_last", 723, Current, 0, 0, 9080);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F724_4480 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("start", 723, Current, 0, 0, 9081);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	*(EIF_INTEGER_32 *)(Current + O3323[dtype-713]) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F724_4467(Current)) == ((EIF_INTEGER_32) 1L))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F724_4468(Current)) == (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3297[dtype-695])(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((nstcall = 0, F724_4478(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F724_4481 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("forth", 723, Current, 0, 0, 9082);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
		ti4_1 = (nstcall = 0, F724_4467(Current));
		tr1 = NULL;
		RTE_O
		tr1 = RTLA;
		RTE_OE
	...
	if (RTAL & CK_ENSURE) {
		...
		RTCO(tr1);
		if ((EIF_BOOLEAN)((nstcall = 0, F724_4467(Current)) == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F724_4482 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F724_4483 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F724_4485 (EIF_REFERENCE Current)
{
