...
EIF_BOOLEAN F511_3418 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 510, Current, 0, 0, 6235);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F511_3424 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune", 510, Current, 0, 1, 6236);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F511_3425 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune_all", 510, Current, 0, 1, 6237);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F511_3428 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 510, Current, 3, 1, 6238);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = 0, F641_4228(Current));
	RTHOOK(8);
	(nstcall = 0, F641_4209(Current, loc1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tr4_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_REAL_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3242[Dtype(loc3)-661])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3296[Dtype(loc3)-695])(loc3));
...
void F511_3429 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 510, Current, 0, 0, 6239);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F326_2638(Current))) break;
		RTHOOK(4);
		(nstcall = 0, F641_4228(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F511_3430 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 510, Current, 2, 1, 6240);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	Result = (nstcall = 0, F641_4236(Current));
	RTHOOK(4);
	if (*(EIF_BOOLEAN *)(Current + O2308[dtype-186])) {
		RTHOOK(5);
		(nstcall = 1, F197_2564(RTCW(Result)));
	}
	RTHOOK(6);
	...
	for (;;) {
		...
		(nstcall = 1, F641_4215(RTCW(Result), tr4_1));
		RTHOOK(9);
