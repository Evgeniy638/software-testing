...
EIF_INTEGER_32 F82_1577 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 81, Current, 0, 0, 1513);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F82_1578_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F82_1578 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(197,F82_1578_body,(Current));
}
