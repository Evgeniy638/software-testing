...
EIF_INTEGER_32 F76_1548 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 75, Current, 0, 0, 1484);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F76_1549_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F76_1549 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(254,F76_1549_body,(Current));
}
