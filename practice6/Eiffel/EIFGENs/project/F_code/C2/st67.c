...
void F68_1430 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("make", 67, Current, 0, 0, 1366);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F68_1431 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("conversion_type_valid", 67, Current, 0, 1, 1367);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F64_1376(Current, arg1));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_BOOLEAN F68_1432 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("overflowed", 67, Current, 0, 0, 1368);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F68_1433 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("underflowed", 67, Current, 0, 0, 1369);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F68_1434 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("parse_successful", 67, Current, 0, 0, 1370);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F68_1435 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("separators_valid", 67, Current, 4, 1, 1371);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F68_1436 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_integral_double", 67, Current, 0, 0, 1372);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F68_1437 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("is_integral_real", 67, Current, 0, 0, 1373);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F68_1436(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_BOOLEAN F68_1438 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_part_of_double", 67, Current, 0, 0, 1374);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F68_1439 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("is_part_of_real", 67, Current, 0, 0, 1375);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F68_1438(Current));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_REAL_64 F68_1440 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("parsed_double", 67, Current, 0, 0, 1376);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REAL_32 F68_1441 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("parsed_real", 67, Current, 0, 0, 1377);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr8_1 = (nstcall = 0, F68_1440(Current));
...
void F68_1442 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REAL_64 tr8_1;
	...
	RTEAA("reset", 67, Current, 0, 1, 1378);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F68_1431(Current, arg1)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	*(EIF_BOOLEAN *)(Current+ _CHROFF_2_5_) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN) !(nstcall = 0, F68_1432(Current))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN) !(nstcall = 0, F68_1433(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F68_1443 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("parse_string_with_type", 67, Current, 8, 2, 1379);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTHOOK(2);
		RTCT("type_valid", EX_PRE);
		RTTE((nstcall = 0, F68_1431(Current, arg2)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	RTHOOK(3);
	(nstcall = 0, F68_1442(Current, arg2));
	RTHOOK(4);
	...
	if (EIF_TEST(loc7)) {
		...
		for (;;) {
			...
			(nstcall = 0, F68_1444(Current, tc1));
			RTHOOK(10);
			loc1++;
		}
	} else {
...
void F68_1444 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("parse_character", 67, Current, 0, 1, 1380);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	switch (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_6_0_1_)) {
		...
		case 8L:
			RTHOOK(73);
			tr1 = *(EIF_REFERENCE *)(Current + _REFACS_1_);
			tb1 = (nstcall = 1, F906_6783(RTCW(tr1), arg1));
			if ((EIF_BOOLEAN) !tb1) {
				RTHOOK(74);
				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_6_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 9L);
			}
...
EIF_REAL_64 F68_1445 (EIF_REFERENCE Current)
{
...
EIF_REAL_64 F68_1446 (EIF_REFERENCE Current)
{
...
EIF_REAL_64 F68_1447 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F68_1448 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F68_1449 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F68_1450 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F68_1451 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F68_1452 (EIF_REFERENCE Current)
{
