...
EIF_INTEGER_32 F73_1545 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 72, Current, 0, 0, 1481);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F73_1546_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F73_1546 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(46,F73_1546_body,(Current));
}
