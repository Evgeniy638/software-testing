...
EIF_INTEGER_32 F94_1597 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 93, Current, 0, 0, 1533);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F94_1598_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F94_1598 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(25,F94_1598_body,(Current));
}
