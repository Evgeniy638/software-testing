...
EIF_INTEGER_32 F80_1573 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 79, Current, 0, 0, 1509);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F80_1574 (EIF_REFERENCE Current)
{
...
static EIF_REFERENCE F80_1575_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F80_1575 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(59,F80_1575_body,(Current));
}

/* {OPERATING_SYSTEM_SIGNAL_FAILURE}.set_signal_code */
void F80_1576 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("set_signal_code", 79, Current, 0, 1, 1512);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
