...
EIF_INTEGER_32 F84_1581 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 83, Current, 0, 0, 1517);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F84_1582_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F84_1582 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(47,F84_1582_body,(Current));
}
