...
EIF_REFERENCE F113_1651 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("string_type", 112, Current, 0, 0, 1584);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F113_1652 (EIF_REFERENCE Current)
{
	return (EIF_INTEGER_32) ((EIF_INTEGER_32) 2000L);
}

/* {STRING_32_SEARCHER}.substring_index_with_deltas */
EIF_INTEGER_32 F113_1653 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2, EIF_INTEGER_32 arg3, EIF_INTEGER_32 arg4)
{
	GTCX
	RTEX;
	...
	RTEAA("substring_index_with_deltas", 112, Current, 9, 4, 1586);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if ((EIF_BOOLEAN)(arg1 == arg2)) {
		...
		for (;;) {
			...
			for (;;) {
				...
				RTHOOK(20);
				tw1 = (nstcall = 1, F564_3187(RTCW(loc8), (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc2) - ((EIF_INTEGER_32) 1L))));
			...
			if (loc5) {
				...
				if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + loc4) <= arg4)) {
					RTHOOK(28);
					tw1 = (nstcall = 1, F564_3187(RTCW(loc8), (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc4) - ((EIF_INTEGER_32) 1L))));
					...
					if ((EIF_BOOLEAN) (loc6 > ((EIF_INTEGER_32) 2000L))) {
						...
						RTHOOK(31);
						ti4_1 = (nstcall = 1, F560_3187(RTCW(loc7), loc6));
						loc1 += ti4_1;
					}
				} else {
					RTHOOK(32);
...
EIF_INTEGER_32 F113_1654 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2, EIF_INTEGER_32 arg3, EIF_INTEGER_32 arg4, EIF_INTEGER_32 arg5)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("fuzzy_index", 112, Current, 11, 5, 1587);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
			...
			if ((EIF_BOOLEAN)(loc9 != NULL)) {
				...
				for (;;) {
					...
					for (;;) {
						...
						RTHOOK(26);
						tw1 = (nstcall = 1, F564_3187(RTCW(loc10), (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc2) - ((EIF_INTEGER_32) 1L))));
						tu4_1 = (EIF_NATURAL_32) tw1;
						tu4_2 = (nstcall = 1, (FUNCTION_CAST(EIF_NATURAL_32, (EIF_REFERENCE, EIF_INTEGER_32)) R4766[Dtype(RTCW(arg2))-907])(arg2, (EIF_INTEGER_32) (loc2 + ((EIF_INTEGER_32) 1L))));
						if ((EIF_BOOLEAN)(tu4_1 != tu4_2)) {
							RTHOOK(27);
					...
					if (loc7) {
						...
						if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + loc5) <= arg4)) {
							...
							for (;;) {
								...
								RTHOOK(39);
								tw1 = (nstcall = 1, F564_3187(RTCW(loc10), (EIF_INTEGER_32) ((EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc5) - loc2) - ((EIF_INTEGER_32) 1L))));
								ti4_1 = (EIF_INTEGER_32) (tw1);
