...
EIF_INTEGER_32 F105_1621 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 104, Current, 0, 0, 1557);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F105_1622_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 104, Current, 0, 0, 1558);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F105_1622 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(235,F105_1622_body,(Current));
}
