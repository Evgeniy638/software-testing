...
EIF_INTEGER_32 F102_1617 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 101, Current, 0, 0, 1553);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F102_1618_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 101, Current, 0, 0, 1554);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F102_1618 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(212,F102_1618_body,(Current));
}
