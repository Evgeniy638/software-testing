...
EIF_INTEGER_32 F108_1627 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("code", 107, Current, 0, 0, 1563);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
static EIF_REFERENCE F108_1628_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("tag", 107, Current, 0, 0, 1564);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F108_1628 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(192,F108_1628_body,(Current));
}
