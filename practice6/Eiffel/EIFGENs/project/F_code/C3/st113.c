...
EIF_REFERENCE F112_1647 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("string_type", 111, Current, 0, 0, 1580);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F112_1648 (EIF_REFERENCE Current)
{
	return (EIF_INTEGER_32) ((EIF_INTEGER_32) 255L);
}

/* {STRING_8_SEARCHER}.substring_index_with_deltas */
EIF_INTEGER_32 F112_1649 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2, EIF_INTEGER_32 arg3, EIF_INTEGER_32 arg4)
{
	GTCX
	RTEX;
	...
	RTEAA("substring_index_with_deltas", 111, Current, 8, 4, 1582);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if ((EIF_BOOLEAN)(arg1 == arg2)) {
		...
		for (;;) {
			...
			for (;;) {
				...
				RTHOOK(20);
				tc1 = (nstcall = 1, F573_3187(RTCW(loc7), (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc2) - ((EIF_INTEGER_32) 1L))));
				tu4_1 = (EIF_NATURAL_32) tc1;
				tu4_2 = (nstcall = 1, (FUNCTION_CAST(EIF_NATURAL_32, (EIF_REFERENCE, EIF_INTEGER_32)) R4766[Dtype(RTCW(arg2))-907])(arg2, (EIF_INTEGER_32) (loc2 + ((EIF_INTEGER_32) 1L))));
			...
			if (loc5) {
				...
				if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + loc4) <= arg4)) {
					RTHOOK(28);
					tc1 = (nstcall = 1, F573_3187(RTCW(loc7), (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc4) - ((EIF_INTEGER_32) 1L))));
					ti4_1 = (EIF_INTEGER_32) (tc1);
					ti4_1 = (nstcall = 1, F560_3187(RTCW(loc6), ti4_1));
					loc1 += ti4_1;
				} else {
					RTHOOK(29);
					loc1++;
...
EIF_INTEGER_32 F112_1650 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2, EIF_INTEGER_32 arg3, EIF_INTEGER_32 arg4, EIF_INTEGER_32 arg5)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("fuzzy_index", 111, Current, 11, 5, 1583);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(arg5 == ti4_1)) {
		...
		if ((EIF_BOOLEAN)(arg5 == ((EIF_INTEGER_32) 0L))) {
			RTHOOK(12);
			Result = (nstcall = 0, F111_1639(Current, arg1, arg2, arg3, arg4));
		} else {
			RTHOOK(13);
			(nstcall = 0, F111_1646(Current, arg2, arg5));
			RTHOOK(14);
			...
			if ((EIF_BOOLEAN)(loc9 != NULL)) {
				...
				for (;;) {
					...
					for (;;) {
						...
						RTHOOK(26);
						tc1 = (nstcall = 1, F573_3187(RTCW(loc10), (EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc2) - ((EIF_INTEGER_32) 1L))));
						tu4_1 = (EIF_NATURAL_32) tc1;
						tu4_2 = (nstcall = 1, (FUNCTION_CAST(EIF_NATURAL_32, (EIF_REFERENCE, EIF_INTEGER_32)) R4766[Dtype(RTCW(arg2))-907])(arg2, (EIF_INTEGER_32) (loc2 + ((EIF_INTEGER_32) 1L))));
						if ((EIF_BOOLEAN)(tu4_1 != tu4_2)) {
							RTHOOK(27);
					...
					if (loc7) {
						...
						if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + loc5) <= arg4)) {
							...
							for (;;) {
								...
								RTHOOK(39);
								tc1 = (nstcall = 1, F573_3187(RTCW(loc10), (EIF_INTEGER_32) ((EIF_INTEGER_32) ((EIF_INTEGER_32) (loc1 + loc5) - loc2) - ((EIF_INTEGER_32) 1L))));
								ti4_1 = (EIF_INTEGER_32) (tc1);
								loc8 = (EIF_INTEGER_32) ti4_1;
								RTHOOK(40);
								tr1 = (nstcall = 1, F559_3187(RTCW(loc9), loc2));
								ti4_1 = (nstcall = 1, F560_3187(RTCW(tr1), loc8));
