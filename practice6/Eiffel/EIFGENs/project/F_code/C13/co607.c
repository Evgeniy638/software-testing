...
EIF_BOOLEAN F209_2570 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 208, Current, 0, 1, 3381);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F209_2573 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 208, Current, 1, 1, 3379);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2318[dtype-470])(Current, (EIF_REFERENCE) &tp1));
		RTHOOK(7);
...
void F209_2575 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 208, Current, 0, 1, 3380);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
