...
EIF_REFERENCE F441_3179 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 440, Current, 0, 0, 4080);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F441_3182 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 440, Current, 0, 0, 4081);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
