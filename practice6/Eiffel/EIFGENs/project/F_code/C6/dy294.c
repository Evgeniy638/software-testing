...
EIF_BOOLEAN F502_3418 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 501, Current, 0, 0, 6181);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F502_3424 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("prune", 501, Current, 0, 1, 6182);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F502_3425 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("prune_all", 501, Current, 0, 1, 6183);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F502_3428 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 501, Current, 3, 1, 6184);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 < arg1)) {
				tr8 = (nstcall = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3242[Dtype(loc2)-661])(loc2));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3296[Dtype(loc2)-695])(loc2));
				tb3 = RTCEQ(tr8, (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_REFERENCE)) R2348[dtype-470])(Current, (EIF_REFERENCE) &ti4_4)));
			}
			tb1 = tb3;
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tr8 = (nstcall = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3242[Dtype(loc3)-661])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3296[Dtype(loc3)-695])(loc3));
				ti4_5 = (EIF_INTEGER_32) (ti4_4 - ((EIF_INTEGER_32) 1L));
				tb3 = RTCEQ(tr8, (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_REFERENCE)) R2348[dtype-470])(Current, (EIF_REFERENCE) &ti4_5)));
			}
			tb1 = tb3;
...
void F502_3429 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("wipe_out", 501, Current, 0, 0, 6185);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2306[dtype-470])(Current))) break;
		RTHOOK(4);
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2360[dtype-546])(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F502_3430 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 501, Current, 2, 1, 6186);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
