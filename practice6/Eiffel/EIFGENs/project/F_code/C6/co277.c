...
/* {CONTAINER}.empty */
EIF_BOOLEAN F187_2561 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("empty", 186, Current, 0, 0, 3268);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F187_2562 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F187_2563 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("changeable_comparison_criterion", 186, Current, 0, 0, 3270);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F187_2564 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_objects", 186, Current, 0, 0, 3271);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F187_2565 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("compare_references", 186, Current, 0, 0, 3272);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F187_2567 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("estimated_count_of", 186, Current, 2, 1, 3273);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
