...
static EIF_REFERENCE F39_816_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("code_pages", 38, Current, 0, 0, 919);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F629_4137(RTCW(tr1), ((EIF_INTEGER_32) 168L)));
	...
	(nstcall = 1, F624_4071(RTCW(Result), tr1, tr3));
	RTHOOK(157);
...
EIF_REFERENCE F39_816 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(213,F39_816_body,(Current));
}

/* {CODE_PAGES}.two_byte_code_pages */
static EIF_REFERENCE F39_817_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
#define Result RTOTRR
	...
	RTEAA("two_byte_code_pages", 38, Current, 0, 0, 920);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F629_4137(RTCW(tr1), ((EIF_INTEGER_32) 8L)));
	Result = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	tr1 = RTMS_EX_H("1200",4,825372720);
	tr2 = RTMS_EX_H("1200",4,825372720);
...
EIF_REFERENCE F39_817 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(214,F39_817_body,(Current));
}

/* {CODE_PAGES}.four_byte_code_pages */
static EIF_REFERENCE F39_818_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
#define Result RTOTRR
	...
	RTEAA("four_byte_code_pages", 38, Current, 0, 0, 921);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F39_818 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(215,F39_818_body,(Current));
}

/* {CODE_PAGES}.big_endian_code_pages */
static EIF_REFERENCE F39_819_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
#define Result RTOTRR
	...
	RTEAA("big_endian_code_pages", 38, Current, 0, 0, 922);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F629_4137(RTCW(tr1), ((EIF_INTEGER_32) 6L)));
	Result = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	tr1 = RTMS_EX_H("1201",4,825372721);
	tr2 = RTMS_EX_H("1201",4,825372721);
...
EIF_REFERENCE F39_819 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(216,F39_819_body,(Current));
}
