...
void F147_2497 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_BOOLEAN arg2, EIF_BOOLEAN arg3)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 146, Current, 0, 3, 3093);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F147_2498 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F147_2499 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F147_2500 (EIF_REFERENCE Current)
{
...
void F147_1 (EIF_REFERENCE Current, int where)
{
	GTCX
