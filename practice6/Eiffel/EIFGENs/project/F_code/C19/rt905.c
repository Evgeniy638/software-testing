...
void F583_2421 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3, EIF_NATURAL_32 arg4)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 582, Current, 0, 4, 2488);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F583_2422 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3)
{
	GTCX
	RTEX;
	...
	RTEAA("local_value_at", 582, Current, 1, 3, 2489);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F583_2423 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3, EIF_INTEGER_16 arg4)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("set_local_value_at", 582, Current, 2, 4, 2490);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_16 F583_2424 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F583_2425 (EIF_REFERENCE Current)
{
...
EIF_NATURAL_32 F583_2426 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F583_2427 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("current_value_record", 582, Current, 0, 0, 2494);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F139_2247(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_1_3_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_1_1_), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_1_0_1_0_)));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_REFERENCE F583_2428 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("associated_object", 582, Current, 0, 0, 2495);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F583_2429 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_TRUE;
}

/* {RT_DBG_LOCAL_RECORD}.is_same_as */
EIF_BOOLEAN F583_2430 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_same_as", 582, Current, 1, 1, 2497);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F583_2431 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("debug_output", 582, Current, 0, 0, 2498);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F583_2432 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("to_string", 582, Current, 1, 0, 2499);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	switch (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_1_2_)) {
		...
		default:
			...
			if (EIF_TRUE) {
				RTHOOK(10);
				Result = (nstcall = 0, F583_2437(Current, loc1));
			} else {
				RTHOOK(11);
				Result = RTLNS(eif_new_type(907, 0x01).id, 907, _OBJSIZ_1_1_0_3_0_0_0_0_);
				(nstcall = -1, F905_6653(RTCW(Result)));
...
void F583_2433 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_16 loc1 = (EIF_INTEGER_16) 0;
	...
	RTEAA("get_value", 582, Current, 1, 0, 2500);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr2 = (nstcall = 0, F583_2422(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_1_3_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_1_1_), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_1_0_1_0_)));
	tr1 = RTCCL(tr2);
	...
	if (tb1) {
		...
		*(EIF_INTEGER_16 *)(Current+ _I16OFF_1_0_0_) = (EIF_INTEGER_16) loc1;
		...
		RTHOOK(3);
		ti2_1 = (nstcall = 0, F583_2438(Current));
...
void F583_2434 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("restore", 582, Current, 0, 1, 2501);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	if ((nstcall = 0, F583_2430(Current, arg1))) {
	} else {
		RTHOOK(3);
		(nstcall = 0, F583_2436(Current, Current));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F583_2435 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("revert", 582, Current, 0, 1, 2502);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	(nstcall = 0, F583_2436(Current, arg1));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
void F583_2436 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("set_local_from_record", 582, Current, 1, 1, 2503);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (EIF_TEST(loc1)) {
		...
		ti2_1 = *(EIF_INTEGER_16 *)(loc1+ _I16OFF_1_0_0_);
		(nstcall = 0, F583_2423(Current, ti4_1, ti4_2, tu4_1, ti2_1));
	} else {
...
EIF_REFERENCE F583_2437 (EIF_REFERENCE Current, EIF_INTEGER_16 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("out_value", 582, Current, 0, 1, 2504);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_16 F583_2438 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("default_value", 582, Current, 0, 0, 2505);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
