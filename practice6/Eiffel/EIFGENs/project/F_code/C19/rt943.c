...
void F586_2421 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3, EIF_NATURAL_32 arg4)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("make", 585, Current, 0, 4, 2542);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F586_2422 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3)
{
	GTCX
	RTEX;
	...
	RTEAA("local_value_at", 585, Current, 1, 3, 2543);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F586_2423 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_NATURAL_32 arg3, EIF_CHARACTER_32 arg4)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("set_local_value_at", 585, Current, 2, 4, 2544);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_CHARACTER_32 F586_2424 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F586_2425 (EIF_REFERENCE Current)
{
...
EIF_NATURAL_32 F586_2426 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F586_2427 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("current_value_record", 585, Current, 0, 0, 2548);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	Result = (nstcall = 0, F139_2247(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_4_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_2_), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_1_0_0_1_)));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTLE;
...
EIF_REFERENCE F586_2428 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("associated_object", 585, Current, 0, 0, 2549);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F586_2429 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_TRUE;
}

/* {RT_DBG_LOCAL_RECORD}.is_same_as */
EIF_BOOLEAN F586_2430 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_same_as", 585, Current, 1, 1, 2551);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F586_2431 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("debug_output", 585, Current, 0, 0, 2552);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F586_2432 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("to_string", 585, Current, 1, 0, 2553);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	switch (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_3_)) {
		...
		default:
			...
			if (EIF_TRUE) {
				RTHOOK(10);
				Result = (nstcall = 0, F586_2437(Current, loc1));
			} else {
				RTHOOK(11);
				Result = RTLNS(eif_new_type(907, 0x01).id, 907, _OBJSIZ_1_1_0_3_0_0_0_0_);
				(nstcall = -1, F905_6653(RTCW(Result)));
...
void F586_2433 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_CHARACTER_32 loc1 = (EIF_CHARACTER_32) 0;
	...
	RTEAA("get_value", 585, Current, 1, 0, 2554);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr2 = (nstcall = 0, F586_2422(Current, *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_4_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_0_0_2_), *(EIF_NATURAL_32 *)(Current+ _LNGOFF_1_0_0_1_)));
	tr1 = RTCCL(tr2);
	...
	if (tb1) {
		...
		*(EIF_CHARACTER_32 *)(Current+ _LNGOFF_1_0_0_0_) = (EIF_CHARACTER_32) loc1;
		...
		RTHOOK(3);
		tw1 = (nstcall = 0, F586_2438(Current));
...
void F586_2434 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("restore", 585, Current, 0, 1, 2555);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	if ((nstcall = 0, F586_2430(Current, arg1))) {
	} else {
		RTHOOK(3);
		(nstcall = 0, F586_2436(Current, Current));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F586_2435 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("revert", 585, Current, 0, 1, 2556);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	(nstcall = 0, F586_2436(Current, arg1));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTLE;
...
void F586_2436 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	RTEAA("set_local_from_record", 585, Current, 1, 1, 2557);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (EIF_TEST(loc1)) {
		...
		tw1 = *(EIF_CHARACTER_32 *)(loc1+ _LNGOFF_1_0_0_0_);
		(nstcall = 0, F586_2423(Current, ti4_1, ti4_2, tu4_1, tw1));
	} else {
...
EIF_REFERENCE F586_2437 (EIF_REFERENCE Current, EIF_CHARACTER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("out_value", 585, Current, 0, 1, 2558);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_CHARACTER_32 F586_2438 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("default_value", 585, Current, 0, 0, 2559);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
