...
/* {DATE_TIME_CODE}.make */
void F556_7701 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("make", 555, Current, 0, 1, 13557);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F54_7533(Current, arg1)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	RTHOOK(3);
	(nstcall = 0, F556_7705(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_BOOLEAN F556_7702 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("is_separator_code", 555, Current, 0, 0, 13558);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F556_7703 (EIF_REFERENCE Current)
{
...
EIF_BOOLEAN F556_7704 (EIF_REFERENCE Current)
{
...
void F556_7705 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("set_value", 555, Current, 1, 1, 13561);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_REFERENCE *)(Current) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	if ((nstcall = 0, F54_7534(Current, *(EIF_REFERENCE *)(Current)))) {
		RTHOOK(5);
		...
		*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
		...
		RTHOOK(13);
		if ((nstcall = 0, F54_7535(Current, *(EIF_REFERENCE *)(Current)))) {
			RTHOOK(14);
			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
			RTHOOK(15);
			...
			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
			...
			RTHOOK(22);
			if ((nstcall = 0, F54_7536(Current, *(EIF_REFERENCE *)(Current)))) {
				RTHOOK(23);
				...
				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
				...
				RTHOOK(31);
				if ((nstcall = 0, F54_7537(Current, *(EIF_REFERENCE *)(Current)))) {
					RTHOOK(32);
					...
					*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_3_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
					...
					RTHOOK(40);
					if ((nstcall = 0, F54_7538(Current, *(EIF_REFERENCE *)(Current)))) {
						RTHOOK(41);
						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
						RTHOOK(42);
						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
						...
						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_3_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
						...
						RTHOOK(49);
						if ((nstcall = 0, F54_7539(Current, *(EIF_REFERENCE *)(Current)))) {
							RTHOOK(50);
							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
							RTHOOK(51);
							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							...
							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
							...
							RTHOOK(58);
							if ((nstcall = 0, F54_7540(Current, *(EIF_REFERENCE *)(Current)))) {
								RTHOOK(59);
								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
								RTHOOK(60);
								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
								...
								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
								...
								RTHOOK(67);
								if ((nstcall = 0, F54_7541(Current, *(EIF_REFERENCE *)(Current)))) {
									RTHOOK(68);
									*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
									RTHOOK(69);
									*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
									...
									*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
									...
									RTHOOK(76);
									if ((nstcall = 0, F54_7542(Current, *(EIF_REFERENCE *)(Current)))) {
										RTHOOK(77);
										*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
										RTHOOK(78);
										*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
										...
										*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
										...
										RTHOOK(85);
										if ((nstcall = 0, F54_7543(Current, *(EIF_REFERENCE *)(Current)))) {
											RTHOOK(86);
											*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
											RTHOOK(87);
											*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
											...
											*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
											...
											RTHOOK(94);
											if ((nstcall = 0, F54_7544(Current, *(EIF_REFERENCE *)(Current)))) {
												RTHOOK(95);
												*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
												RTHOOK(96);
												*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
												...
												*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
												...
												RTHOOK(103);
												if ((nstcall = 0, F54_7546(Current, *(EIF_REFERENCE *)(Current)))) {
													RTHOOK(104);
													*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
													RTHOOK(105);
													*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
													...
													*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
													...
													RTHOOK(112);
													if ((nstcall = 0, F54_7547(Current, *(EIF_REFERENCE *)(Current)))) {
														RTHOOK(113);
														*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
														RTHOOK(114);
														*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
														...
														*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
														...
														RTHOOK(121);
														if ((nstcall = 0, F54_7548(Current, *(EIF_REFERENCE *)(Current)))) {
															RTHOOK(122);
															*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
															RTHOOK(123);
															*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
															...
															*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
															...
															RTHOOK(130);
															if ((nstcall = 0, F54_7549(Current, *(EIF_REFERENCE *)(Current)))) {
																RTHOOK(131);
																*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
																RTHOOK(132);
																*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
																...
																*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																...
																RTHOOK(139);
																if ((nstcall = 0, F54_7550(Current, *(EIF_REFERENCE *)(Current)))) {
																	RTHOOK(140);
																	tr1 = *(EIF_REFERENCE *)(Current);
																	tr2 = *(EIF_REFERENCE *)(Current);
																	ti4_1 = *(EIF_INTEGER_32 *)(RTCW(tr2) + O4892[Dtype(tr2)-905]);
																	tr2 = (nstcall = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32, EIF_INTEGER_32)) R4844[Dtype(RTCW(tr1))-907])(tr1, ((EIF_INTEGER_32) 3L), ti4_1));
																	ti4_1 = (nstcall = 1, F905_6718(RTCW(tr2)));
																	...
																	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_3_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
																	...
																	RTHOOK(148);
																	if ((nstcall = 0, F54_7551(Current, *(EIF_REFERENCE *)(Current)))) {
																		RTHOOK(149);
																		...
																		*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																		...
																		RTHOOK(155);
																		if ((nstcall = 0, F54_7552(Current, *(EIF_REFERENCE *)(Current)))) {
																			RTHOOK(156);
																			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																			RTHOOK(157);
																			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																			...
																			*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																			...
																			RTHOOK(162);
																			if ((nstcall = 0, F54_7553(Current, *(EIF_REFERENCE *)(Current)))) {
																				RTHOOK(163);
																				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																				RTHOOK(164);
																				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																				...
																				*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																				...
																				RTHOOK(169);
																				if ((nstcall = 0, F54_7554(Current, *(EIF_REFERENCE *)(Current)))) {
																					RTHOOK(170);
																					*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																					RTHOOK(171);
																					*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																					...
																					*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																					...
																					RTHOOK(176);
																					if ((nstcall = 0, F54_7555(Current, *(EIF_REFERENCE *)(Current)))) {
																						RTHOOK(177);
																						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																						RTHOOK(178);
																						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																						...
																						*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																						...
																						RTHOOK(183);
																						if ((nstcall = 0, F54_7556(Current, *(EIF_REFERENCE *)(Current)))) {
																							RTHOOK(184);
																							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																							RTHOOK(185);
																							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																							...
																							*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_) = (EIF_INTEGER_32) ti4_1;
																							...
																							RTHOOK(190);
																							if ((nstcall = 0, F54_7558(Current, *(EIF_REFERENCE *)(Current)))) {
																								RTHOOK(191);
																								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_0_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
																								RTHOOK(192);
																								*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_1_) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
...
EIF_REFERENCE F556_7706 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F556_7707 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F556_7708 (EIF_REFERENCE Current)
{
...
/* {DATE_TIME_CODE}.name */
EIF_REFERENCE F556_7709 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F556_7710 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F556_7711 (EIF_REFERENCE Current)
{
...
/* {DATE_TIME_CODE}.type */
EIF_INTEGER_32 F556_7712 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F556_7713 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("debug_output", 555, Current, 0, 0, 13569);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(2);
	(nstcall = 1, F908_6878(RTCW(Result), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_2_0_4_)));
	RTHOOK(3);
	tr1 = RTMS_EX_H(" -> ",4,539835936);
	(nstcall = 1, F908_6875(RTCW(Result), tr1));
	RTHOOK(4);
	(nstcall = 1, F908_6875(RTCW(Result), *(EIF_REFERENCE *)(Current + _REFACS_1_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
