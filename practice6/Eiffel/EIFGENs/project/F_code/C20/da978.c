...
EIF_REFERENCE F35_7442 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (276,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
static EIF_REFERENCE F35_7443_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTEAA("days_text", 34, Current, 0, 0, 13327);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(1);
	{
		static EIF_TYPE_INDEX typarr0[] = {558,0xFF01,907,0xFFFF};
		EIF_TYPE typres0;
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	RTAR(tr2,tr3);
	tr1 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) F559_3193)(tr2);
...
EIF_REFERENCE F35_7443 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(268,F35_7443_body,(Current));
}

/* {DATE_TIME_TOOLS}.months_text */
static EIF_REFERENCE F35_7444_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
#define Result RTOTRR
	...
	RTEAA("months_text", 34, Current, 0, 0, 13328);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F35_7444 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(269,F35_7444_body,(Current));
}

/* {DATE_TIME_TOOLS}.long_days_text */
static EIF_REFERENCE F35_7445_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
#define Result RTOTRR
	...
	RTEAA("long_days_text", 34, Current, 0, 0, 13329);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F35_7445 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(270,F35_7445_body,(Current));
}

/* {DATE_TIME_TOOLS}.long_months_text */
static EIF_REFERENCE F35_7446_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
#define Result RTOTRR
	...
	RTEAA("long_months_text", 34, Current, 0, 0, 13330);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F35_7446 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(271,F35_7446_body,(Current));
}

/* {DATE_TIME_TOOLS}.date_default_format_string */

EIF_REFERENCE F35_7447 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (267,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}

/* {DATE_TIME_TOOLS}.time_default_format_string */

EIF_REFERENCE F35_7448 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (273,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}

/* {DATE_TIME_TOOLS}.default_format_string */

EIF_REFERENCE F35_7449 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (275,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
