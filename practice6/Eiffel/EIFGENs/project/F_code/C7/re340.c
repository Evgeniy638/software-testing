...
EIF_REFERENCE F443_3179 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 442, Current, 0, 0, 4086);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F443_3182 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 442, Current, 0, 0, 4087);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
