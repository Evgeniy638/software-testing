...
EIF_CHARACTER_32 F682_4426 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 681, Current, 0, 0, 8515);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tw1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_CHARACTER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2654[Dtype(RTCW(tr1))-470])(tr1, ti4_1));
