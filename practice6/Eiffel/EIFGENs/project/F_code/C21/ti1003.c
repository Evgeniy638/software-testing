...
EIF_BOOLEAN F922_7833 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2)
{
	GTCX
	RTEX;
	...
	RTEAA("time_valid", 921, Current, 1, 2, 13690);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	Result = '\0';
	tb1 = '\0';
	tb2 = (nstcall = 1, F916_7779(RTCW(loc1)));
	if (tb2) {
		tb2 = (nstcall = 1, F916_7770(RTCW(loc1), arg1));
		tb1 = tb2;
	}
	if (tb1) {
		tb1 = (nstcall = 1, F916_7765(RTCW(loc1), arg1));
		Result = tb1;
	}
	RTVI(Current, RTAL);
	RTRS;
...
EIF_BOOLEAN F922_7834 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("compact_time_valid", 921, Current, 4, 1, 13691);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	loc4 = *(EIF_INTEGER_32 *)(Current + O5229[dtype-48]);
	RTHOOK(2);
	*(EIF_INTEGER_32 *)(Current + O5229[dtype-48]) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
	loc1 = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R5219[dtype-48])(Current));
	RTHOOK(4);
	loc2 = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R5220[dtype-48])(Current));
	RTHOOK(5);
	loc3 = (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R5221[dtype-48])(Current));
	RTHOOK(6);
	*(EIF_INTEGER_32 *)(Current + O5229[dtype-48]) = (EIF_INTEGER_32) loc4;
	RTHOOK(7);
...
EIF_BOOLEAN F922_7835 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_REAL_64 arg3, EIF_BOOLEAN arg4)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	RTEAA("is_correct_time", 921, Current, 2, 4, 13692);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
