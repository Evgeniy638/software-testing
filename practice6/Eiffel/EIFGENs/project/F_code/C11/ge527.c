...
EIF_NATURAL_16 F720_4466 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 719, Current, 0, 0, 8991);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((EIF_BOOLEAN) !(nstcall = 0, F720_4475(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	tu2_1 = (nstcall = 1, F565_3187(RTCW(tr1), *(EIF_INTEGER_32 *)(Current + O3323[dtype-713])));
...
EIF_INTEGER_32 F720_4467 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("cursor_index", 719, Current, 0, 0, 8992);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F720_4468 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("target_index", 719, Current, 0, 0, 8993);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F720_4469 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("last_index", 719, Current, 0, 0, 8994);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_INTEGER_32 F720_4470 (EIF_REFERENCE Current)
{
	return (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
}

/* {GENERAL_SPECIAL_ITERATION_CURSOR}.reversed */
EIF_REFERENCE F720_4471 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("reversed", 719, Current, 0, 0, 8996);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
		...
		Result = RTLNS(typres0.id, 701, _OBJSIZ_1_1_0_5_0_0_0_0_);
	}
	tr1 = (nstcall = 0, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3309[dtype-695])(Current));
	(nstcall = -1, F702_4432(RTCW(Result), tr1));
	RTHOOK(2);
	(nstcall = 1, F702_4449(RTCW(Result)));
	RTHOOK(3);
	(nstcall = 1, F702_4451(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("is_reversed", EX_POST);
		tb1 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R3304[Dtype(RTCW(Result))-695])(Result));
		if ((EIF_BOOLEAN)(tb1 == (EIF_BOOLEAN) !(nstcall = 0, F720_4476(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN)(ti4_1 == (nstcall = 0, F720_4470(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F720_4472 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("incremented", 719, Current, 0, 1, 8997);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
		RTTE((EIF_BOOLEAN) ((EIF_INTEGER_32) ((nstcall = 0, F720_4470(Current)) + arg1) > ((EIF_INTEGER_32) 0L)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	...
	(nstcall = -1, F702_4432(RTCW(Result), tr1));
	RTHOOK(3);
	(nstcall = 1, F702_4450(RTCW(Result), (EIF_INTEGER_32) (((EIF_INTEGER_32) 1L) + arg1)));
	RTHOOK(4);
	(nstcall = 1, F702_4451(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		...
		ti4_1 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3299[Dtype(RTCW(Result))-695])(Result));
		if ((EIF_BOOLEAN)(ti4_1 == (EIF_INTEGER_32) ((nstcall = 0, F720_4470(Current)) + arg1))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		tb1 = (nstcall = 1, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R3304[Dtype(RTCW(Result))-695])(Result));
		if ((EIF_BOOLEAN)(tb1 == (nstcall = 0, F720_4476(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F720_4473 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("decremented", 719, Current, 0, 1, 8998);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("n_valid", EX_PRE);
		RTTE((EIF_BOOLEAN) ((nstcall = 0, F720_4470(Current)) > arg1), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
EIF_REFERENCE F720_4474 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("with_step", 719, Current, 0, 1, 8999);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = -1, F702_4432(RTCW(Result), tr1));
	RTHOOK(3);
	(nstcall = 1, F702_4450(RTCW(Result), arg1));
	RTHOOK(4);
	(nstcall = 1, F702_4451(RTCW(Result)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
EIF_BOOLEAN F720_4475 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("after", 719, Current, 0, 0, 9000);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F720_4476 (EIF_REFERENCE Current)
{
	return (EIF_BOOLEAN) EIF_FALSE;
}

/* {GENERAL_SPECIAL_ITERATION_CURSOR}.is_valid */
EIF_BOOLEAN F720_4477 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_valid", 719, Current, 0, 0, 9002);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	ti4_2 = (nstcall = 0, F720_4469(Current));
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN)(ti4_1 == ti4_2);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
EIF_BOOLEAN F720_4478 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_first", 719, Current, 0, 0, 9003);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_BOOLEAN F720_4479 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("is_last", 719, Current, 0, 0, 9004);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F720_4480 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("start", 719, Current, 0, 0, 9005);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	*(EIF_INTEGER_32 *)(Current + O3323[dtype-713]) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F720_4467(Current)) == ((EIF_INTEGER_32) 1L))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F720_4468(Current)) == (nstcall = 0, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3297[dtype-695])(Current)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		if ((nstcall = 0, F720_4478(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F720_4481 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("forth", 719, Current, 0, 0, 9006);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
		ti4_1 = (nstcall = 0, F720_4467(Current));
		tr1 = NULL;
		RTE_O
		tr1 = RTLA;
		RTE_OE
	...
	if (RTAL & CK_ENSURE) {
		...
		RTCO(tr1);
		if ((EIF_BOOLEAN)((nstcall = 0, F720_4467(Current)) == (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_REFERENCE F720_4482 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F720_4483 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F720_4485 (EIF_REFERENCE Current)
{
