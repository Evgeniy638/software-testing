...
/* {BILINEAR}.off */
EIF_BOOLEAN F415_2811 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("off", 414, Current, 0, 0, 3927);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BILINEAR}.search */
void F415_2814 (EIF_REFERENCE Current, EIF_CHARACTER_32 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 414, Current, 0, 1, 3928);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(3);
	(nstcall = 0, F396_2705(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
