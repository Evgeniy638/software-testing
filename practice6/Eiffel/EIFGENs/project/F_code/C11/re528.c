...
EIF_REFERENCE F447_3179 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 446, Current, 0, 0, 4098);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F702_4432(RTCW(Result), Current));
	RTHOOK(2);
...
EIF_REFERENCE F447_3182 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("index_set", 446, Current, 0, 0, 4099);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
