...
EIF_BOOLEAN F208_2570 (EIF_REFERENCE Current, EIF_NATURAL_16 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 207, Current, 0, 1, 3378);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F208_2573 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 207, Current, 1, 1, 3376);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2318[dtype-470])(Current, (EIF_REFERENCE) &tu2_1));
		RTHOOK(7);
...
void F208_2575 (EIF_REFERENCE Current, EIF_NATURAL_16 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 207, Current, 0, 1, 3377);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
