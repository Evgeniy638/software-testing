...
/* {SEQUENCE}.readable */
EIF_BOOLEAN F429_2850 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("readable", 428, Current, 0, 0, 3989);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.writable */
EIF_BOOLEAN F429_2851 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("writable", 428, Current, 0, 0, 3990);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.force */
void F429_2852 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("force", 428, Current, 0, 1, 3984);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F429_2853 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("append", 428, Current, 1, 1, 3985);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.put */
void F429_2854 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("put", 428, Current, 0, 1, 3986);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.prune */
void F429_2855 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune", 428, Current, 0, 1, 3987);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.prune_all */
void F429_2856 (EIF_REFERENCE Current, EIF_BOOLEAN arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 428, Current, 0, 1, 3988);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
