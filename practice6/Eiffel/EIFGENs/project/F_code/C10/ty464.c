...
EIF_BOOLEAN F686_4426 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 685, Current, 0, 0, 8519);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tb1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_BOOLEAN *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2654[Dtype(RTCW(tr1))-470])(tr1, ti4_1));
