...
/* {LIST}.is_equal */
EIF_BOOLEAN F521_3433 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_equal", 520, Current, 2, 1, 6288);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		if ((EIF_BOOLEAN)((nstcall = 0, F321_2638(Current)) == tb2)) {
		...
		if (tb1) {
			...
			if ((nstcall = 0, F321_2638(Current))) {
				tb4 = (nstcall = 1, F321_2638(RTCW(arg1)));
				tb3 = tb4;
			}
			if (tb3) {
...
/* {LIST}.after */
EIF_BOOLEAN F521_3434 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("after", 520, Current, 0, 0, 6289);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {LIST}.before */
EIF_BOOLEAN F521_3435 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_INTEGER_32 ti4_1;
	...
	RTEAA("before", 520, Current, 0, 0, 6290);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
