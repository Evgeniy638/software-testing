...
EIF_BOOLEAN F206_2570 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 205, Current, 0, 1, 3372);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F206_2573 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 205, Current, 1, 1, 3370);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2318[dtype-470])(Current, (EIF_REFERENCE) &tr8_1));
		RTHOOK(7);
...
void F206_2575 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 205, Current, 0, 1, 3371);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
