...
/* {SEQUENCE}.readable */
EIF_BOOLEAN F426_2850 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("readable", 425, Current, 0, 0, 3968);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.writable */
EIF_BOOLEAN F426_2851 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTEAA("writable", 425, Current, 0, 0, 3969);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.force */
void F426_2852 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("force", 425, Current, 0, 1, 3963);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F426_2853 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("append", 425, Current, 1, 1, 3964);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.put */
void F426_2854 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("put", 425, Current, 0, 1, 3965);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.prune */
void F426_2855 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune", 425, Current, 0, 1, 3966);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.prune_all */
void F426_2856 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 425, Current, 0, 1, 3967);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
