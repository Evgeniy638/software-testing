...
EIF_BOOLEAN F503_3418 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 502, Current, 0, 0, 6187);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F503_3424 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune", 502, Current, 0, 1, 6188);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F503_3425 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 502, Current, 0, 1, 6189);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F503_3428 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 502, Current, 3, 1, 6190);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 < arg1)) {
				...
				tb3 = (EIF_BOOLEAN)(ti4_4 == (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_REFERENCE)) R2348[dtype-470])(Current, (EIF_REFERENCE) &ti4_5)));
			}
			tb1 = tb3;
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				ti4_4 = (nstcall = 1, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3242[Dtype(loc3)-661])(loc3));
				ti4_5 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3296[Dtype(loc3)-695])(loc3));
				ti4_6 = (EIF_INTEGER_32) (ti4_5 - ((EIF_INTEGER_32) 1L));
				tb3 = (EIF_BOOLEAN)(ti4_4 == (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_REFERENCE)) R2348[dtype-470])(Current, (EIF_REFERENCE) &ti4_6)));
			}
			tb1 = tb3;
...
void F503_3429 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("wipe_out", 502, Current, 0, 0, 6191);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F318_2638(Current))) break;
		RTHOOK(4);
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE)) R2360[dtype-546])(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F503_3430 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 502, Current, 2, 1, 6192);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(8);
		ti4_1 = (nstcall = 0, eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2355[dtype-546])(Current));
		(nstcall = 1, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2318[Dtype(RTCW(Result))-470])(Result, (EIF_REFERENCE) &ti4_1));
		RTHOOK(9);
