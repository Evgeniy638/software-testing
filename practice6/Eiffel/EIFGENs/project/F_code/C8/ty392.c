...
EIF_NATURAL_32 F684_4426 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 683, Current, 0, 0, 8517);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	tu4_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_NATURAL_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2654[Dtype(RTCW(tr1))-470])(tr1, ti4_1));
