...
EIF_BOOLEAN F515_3418 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 514, Current, 0, 0, 6259);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F515_3424 (EIF_REFERENCE Current, EIF_INTEGER_16 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune", 514, Current, 0, 1, 6260);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F515_3425 (EIF_REFERENCE Current, EIF_INTEGER_16 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune_all", 514, Current, 0, 1, 6261);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
void F515_3428 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 514, Current, 3, 1, 6262);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	(nstcall = 0, F645_4228(Current));
	RTHOOK(8);
	(nstcall = 0, F645_4209(Current, loc1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				ti2_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_INTEGER_16 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3242[Dtype(loc3)-661])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3296[Dtype(loc3)-695])(loc3));
...
void F515_3429 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 514, Current, 0, 0, 6263);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F330_2638(Current))) break;
		RTHOOK(4);
		(nstcall = 0, F645_4228(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F515_3430 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 514, Current, 2, 1, 6264);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	Result = (nstcall = 0, F645_4236(Current));
	RTHOOK(4);
	if (*(EIF_BOOLEAN *)(Current + O2308[dtype-186])) {
		RTHOOK(5);
		(nstcall = 1, F201_2564(RTCW(Result)));
	}
	RTHOOK(6);
	...
	for (;;) {
		...
		(nstcall = 1, F645_4215(RTCW(Result), ti2_1));
		RTHOOK(9);
