...
/* {BILINEAR}.off */
EIF_BOOLEAN F424_2811 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("off", 423, Current, 0, 0, 3954);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {BILINEAR}.search */
void F424_2814 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTEX;
	EIF_BOOLEAN tb1;
	...
	RTEAA("search", 423, Current, 0, 1, 3955);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	RTHOOK(3);
	(nstcall = 0, F404_2705(Current, arg1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		...
		if (tb2) {
			tb1 = (EIF_BOOLEAN)(arg1 == (nstcall = 0, eif_optimize_return = 1, *(EIF_CHARACTER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2387[dtype-546])(Current)));
		}
		if (tb1) {
			RTCK;
		} else {
...
void F424_1 (EIF_REFERENCE Current, int where)
{
	...
	RTLR(0,Current);
	RTLIU(1);
	RTEAINV(l_feature_name, 880, Current, 0, 0);
