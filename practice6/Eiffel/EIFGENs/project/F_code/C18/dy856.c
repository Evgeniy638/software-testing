...
void F545_3572 (EIF_REFERENCE Current, EIF_INTEGER_16 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("put_left", 544, Current, 1, 1, 6383);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if ((nstcall = 0, F330_2638(Current))) {
		RTHOOK(4);
		(nstcall = 0, F645_4212(Current, arg1));
	} else {
		RTHOOK(5);
		if ((nstcall = 0, F530_3434(Current))) {
			...
			RTHOOK(7);
			(nstcall = 0, F645_4217(Current, arg1));
			RTHOOK(8);
			(nstcall = 0, F645_4204(Current, ((EIF_INTEGER_32) 2L)));
		} else {
			RTHOOK(9);
			...
			RTHOOK(11);
			(nstcall = 0, F645_4217(Current, loc1));
			RTHOOK(12);
...
void F545_3574 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("merge_left", 544, Current, 0, 1, 6384);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		ti2_1 = (nstcall = 1, F645_4179(RTCW(arg1)));
		(nstcall = 0, F645_4216(Current, ti2_1));
		RTHOOK(8);
		(nstcall = 1, F645_4228(RTCW(arg1)));
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		RTCT("new_count", EX_POST);
...
void F545_3575 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("merge_right", 544, Current, 0, 1, 6385);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		RTHOOK(7);
		ti2_1 = (nstcall = 1, F645_4179(RTCW(arg1)));
		(nstcall = 0, F645_4217(Current, ti2_1));
		RTHOOK(8);
		(nstcall = 1, F645_4208(RTCW(arg1)));
		RTHOOK(9);
		(nstcall = 1, F645_4232(RTCW(arg1)));
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
		RTCT("new_count", EX_POST);
...
void F545_3579 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 544, Current, 0, 0, 6386);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	RTHOOK(1);
	(nstcall = 0, F515_3429(Current));
	RTHOOK(2);
	(nstcall = 0, F645_4208(Current));
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
