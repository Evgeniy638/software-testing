...
EIF_BOOLEAN F215_2570 (EIF_REFERENCE Current, EIF_INTEGER_8 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 214, Current, 0, 1, 3399);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F215_2573 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 214, Current, 1, 1, 3397);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(4);
	(nstcall = 1, F644_4205(RTCW(loc1)));
	for (;;) {
		RTHOOK(5);
		tb1 = '\01';
		if (!(EIF_BOOLEAN) !(nstcall = 0, (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R2314[dtype-470])(Current))) {
			tb2 = (nstcall = 1, F499_3372(RTCW(loc1)));
			tb1 = tb2;
		}
		if (tb1) break;
		RTHOOK(6);
		ti1_1 = (nstcall = 1, F644_4179(RTCW(loc1)));
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2318[dtype-470])(Current, (EIF_REFERENCE) &ti1_1));
		RTHOOK(7);
		(nstcall = 1, F644_4207(RTCW(loc1)));
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(8);
...
void F215_2575 (EIF_REFERENCE Current, EIF_INTEGER_8 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 214, Current, 0, 1, 3398);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
