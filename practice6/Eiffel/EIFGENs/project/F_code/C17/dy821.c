...
EIF_BOOLEAN F514_3418 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("extendible", 513, Current, 0, 0, 6253);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {DYNAMIC_CHAIN}.prune */
void F514_3424 (EIF_REFERENCE Current, EIF_INTEGER_8 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune", 513, Current, 0, 1, 6254);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F644_4199(Current)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
void F514_3425 (EIF_REFERENCE Current, EIF_INTEGER_8 arg1)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("prune_all", 513, Current, 0, 1, 6255);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN) !(nstcall = 0, F644_4186(Current, arg1))) {
			RTCK;
		} else {
			RTCF;
		}
...
void F514_3428 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("remove_i_th", 513, Current, 3, 1, 6256);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTTE((nstcall = 0, F644_4201(Current, arg1)), label_1);
		RTCK;
		RTJB;
label_1:
		RTCF;
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
		ti4_1 = (nstcall = 0, F644_4195(Current));
		tr1 = NULL;
		RTE_O
		tr1 = RTLA;
		RTE_OE
	...
	RTHOOK(6);
	(nstcall = 0, F644_4209(Current, arg1));
	RTHOOK(7);
	(nstcall = 0, F644_4228(Current));
	RTHOOK(8);
	(nstcall = 0, F644_4209(Current, loc1));
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		RTCT("new_count", EX_POST);
		RTCO(tr1);
		if ((EIF_BOOLEAN)((nstcall = 0, F644_4195(Current)) == (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L)))) {
			RTCK;
		} else {
			RTCF;
		}
		...
		RTCO(tr3);
		tr6 = (nstcall = 1, F644_4188(RTCV(tr2)));
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 < arg1)) {
				ti1_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_INTEGER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3242[Dtype(loc2)-661])(loc2));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3296[Dtype(loc2)-695])(loc2));
				tb3 = (EIF_BOOLEAN)(ti1_1 == (nstcall = 0, F644_4180(Current, ti4_4)));
			}
			tb1 = tb3;
		...
		RTCO(tr5);
		tr6 = (nstcall = 1, F644_4188(RTCV(tr4)));
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				ti1_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_INTEGER_8 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3242[Dtype(loc3)-661])(loc3));
				ti4_4 = (nstcall = 1, (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R3296[Dtype(loc3)-695])(loc3));
				tb3 = (EIF_BOOLEAN)(ti1_1 == (nstcall = 0, F644_4180(Current, (EIF_INTEGER_32) (ti4_4 - ((EIF_INTEGER_32) 1L)))));
			}
			tb1 = tb3;
...
void F514_3429 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	RTSN;
	...
	RTEAA("wipe_out", 513, Current, 0, 0, 6257);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		RTHOOK(3);
		if ((nstcall = 0, F329_2638(Current))) break;
		RTHOOK(4);
		(nstcall = 0, F644_4228(Current));
	}
	if (RTAL & CK_ENSURE) {
...
EIF_REFERENCE F514_3430 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("duplicate", 513, Current, 2, 1, 6258);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		if ((nstcall = 0, F499_3372(Current))) {
			tb1 = (nstcall = 0, F529_3434(Current));
		}
		RTTE(tb1, label_1);
		RTCK;
		RTHOOK(2);
...
body:;
	RTHOOK(3);
	Result = (nstcall = 0, F644_4236(Current));
	RTHOOK(4);
	if (*(EIF_BOOLEAN *)(Current + O2308[dtype-186])) {
		RTHOOK(5);
		(nstcall = 1, F200_2564(RTCW(Result)));
	}
	RTHOOK(6);
	loc1 = (nstcall = 0, F644_4185(Current));
	for (;;) {
		RTHOOK(7);
		tb1 = '\01';
		if (!(EIF_BOOLEAN)(loc2 == arg1)) {
			tb1 = (nstcall = 0, F408_2709(Current));
		}
		if (tb1) break;
		RTHOOK(8);
		ti1_1 = (nstcall = 0, F644_4179(Current));
		(nstcall = 1, F644_4215(RTCW(Result), ti1_1));
		RTHOOK(9);
	...
	RTHOOK(11);
	(nstcall = 0, F644_4210(Current, loc1));
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(12);
	RTLE;
