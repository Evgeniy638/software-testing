...
EIF_BOOLEAN F216_2570 (EIF_REFERENCE Current, EIF_INTEGER_16 arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("is_inserted", 215, Current, 0, 1, 3402);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
/* {COLLECTION}.fill */
void F216_2573 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("fill", 215, Current, 1, 1, 3400);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		(nstcall = 0, (FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R2318[dtype-470])(Current, (EIF_REFERENCE) &ti2_1));
		RTHOOK(7);
...
void F216_2575 (EIF_REFERENCE Current, EIF_INTEGER_16 arg1)
{
	GTCX
	RTEX;
	RTCDT;
	...
	RTEAA("prune_all", 215, Current, 0, 1, 3401);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
