...
EIF_INTEGER_16 F695_4426 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("item", 694, Current, 0, 0, 8528);
	RTSA(dtype);
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	ti2_1 = (nstcall = 1, eif_optimize_return = 1, *(EIF_INTEGER_16 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2654[Dtype(RTCW(tr1))-470])(tr1, ti4_1));
