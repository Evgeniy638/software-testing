...
void F758_4504 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	RTEX;
	...
	RTEAA("make", 757, Current, 0, 1, 9336);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_0_0_1_) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ti4_2);
	if (RTAL & CK_ENSURE) {
		...
		if ((nstcall = 0, F758_4507(Current))) {
			RTCK;
		} else {
			RTCF;
		}
...
EIF_INTEGER_32 F758_4505 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F758_4506 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	...
	RTEAA("new_cursor", 757, Current, 0, 0, 9338);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
	...
	(nstcall = -1, F758_4504(RTCW(Result), *(EIF_REFERENCE *)(Current + _REFACS_1_)));
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_BOOLEAN F758_4507 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
	...
	RTEAA("is_valid", 757, Current, 0, 0, 9339);
	RTSA(Dtype(Current));
	RTSC;
	RTGC;
	RTIV(Current, RTAL);
...
EIF_REFERENCE F758_4508 (EIF_REFERENCE Current)
{
...
EIF_INTEGER_32 F758_4509 (EIF_REFERENCE Current)
{
