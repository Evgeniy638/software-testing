...
extern EIF_TYPED_VALUE F978_7449(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F978_7442,13327,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 977, Current, 0, 0, 13327);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(977, Current, 13327);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {264,0xFF01,240,0xFFFF};
		EIF_TYPE typres0;
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2310, "compare_objects", Result))(Result);
	RTVI(Current, RTAL);
	RTRS;
	RTOTE;
	RTHOOK(3);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 977, Current, 0, 0, 13328);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(977, Current, 13328);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000112, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 977, Current, 0, 0, 13329);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(977, Current, 13329);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000112, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 977, Current, 0, 0, 13330);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(977, Current, 13330);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000112, 0,0); /* Result */
...
{
	GTCX
	RTOTC (F978_7447,13332,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F978_7448,13333,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F978_7449 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F978_7449,13334,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit978 (void)
{
	GTCX
	RTOTS (7442,F978_7442)
	RTOTS (7443,F978_7443)
	RTOTS (7444,F978_7444)
	RTOTS (7445,F978_7445)
	RTOTS (7446,F978_7446)
	RTOTS (7447,F978_7447)
	RTOTS (7448,F978_7448)
	RTOTS (7449,F978_7449)
}
